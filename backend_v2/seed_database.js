...
async function seedDatabase() {
  ...
  try {
    ...
    for (const product of products) {
      await client.query(
        `INSERT INTO products (sku, barcode, name, category_id, unit, cost_price, selling_price, min_stock, max_stock, reorder_point, is_active, is_trackable)
         SELECT $1, $2, $3, c.id, $4, $5, $6, $7, $8, $9, true, true
         FROM categories c
         WHERE c.name = $10
