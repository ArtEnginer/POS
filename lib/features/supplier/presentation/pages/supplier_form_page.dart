...
class _SupplierFormPageState extends State<SupplierFormPage> {
  ...
  void _generateSupplierCode() {
    ...
    final code =
        'SUP-${timestamp.year}${timestamp.month.toString().padLeft(2, '0')}${timestamp.day.toString().padLeft(2, '0')}-${timestamp.hour.toString().padLeft(2, '0')}${timestamp.minute.toString().padLeft(2, '0')}${timestamp.second.toString().padLeft(2, '0')}';
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Termin Pembayaran (Hari)',
                    border: OutlineInputBorder(),
